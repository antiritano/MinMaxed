        ...
        <div className="dark:bg-gray-900">
          ...
          <div className="mx-auto container w-full flex items-center md:flex-row flex-col-reverse justify-between px-6 lg:px-0">
            <div className="flex flex-col justify-start items-start lg:w-2/5 px-2 lg:px-0">
              <div className="mb-3">
                <p className="lg:text-sm text-xs text-gray-600 dark:text-gray-300 font-medium leading-none">Written by: Anthony Iritano</p>
              </div>
              <div className="mt-3">
                <p className="text-gray-800 dark:text-white lg:text-4xl text-3xl font-extrabold leading-9">Elden Ring</p>
              </div>
              <div className="mt-3 ">
                <p className="lg:text-base text-sm leading-normal text-gray-600 dark:text-gray-300">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              </div>
              <div className="grid grid-cols-2 mt-8 mb-8 gap-y-6">
                <div>
                  <p className="text-gray-800 dark:text-white text-sm lg:text-base font-bold leading-none">
                    Platform: <span className="font-semibold md:font-medium">PC</span>
                  </p>
                </div>
                <div>
                  <p className="text-gray-800 dark:text-white text-sm lg:text-base font-bold leading-none">
                    Developer: <span className="font-semibold md:font-medium">FromSoftware</span>
                  </p>
                </div>
                <div>
                  <p className="text-gray-800 dark:text-white text-sm lg:text-base font-bold leading-none">
                    Release: <span className="font-semibold md:font-medium">2022</span>
                  </p>
                </div>
                <div>
                  <p className="text-gray-800 dark:text-white text-sm lg:text-base font-bold leading-none">
                    Posted: <span className="font-semibold md:font-medium">2022</span>
                  </p>
                </div>
              </div>
            </div>
            <div className="flex justify-center items-center object-cover lg:w-4/5 mt-10 md:mt-0 pl-10 lg:-mr-48 mr-0">
              <img className="w-full border-black" src="https://www.denofgeek.com/wp-content/uploads/2021/11/Elden-Ring-gmaeplay.jpg" alt="" />
            </div>
          </div>
          </div>
          <div className="mx-auto container w-full flex xl:flex-row flex-col justify-between items-start mt-12 px-6 lg:px-0">
            <div className="flex flex-col justify-start items-start xl:w-2/4">
              <div>
                <h2 className="text-gray-800 dark:text-white lg:text-3xl text-2xl font-bold leading-7">The Review</h2>
              </div>
              <div className="mt-8">
              ...
              <div className="mt-8 flex justify-start items-start flex-col">
                <div>
                  <p className="text-gray-800 dark:text-white lg:text-base text-sm font-semibold leading-none">Breakdown</p>
                </div>
                ...
                <div className="mt-8 flex-col justify-start items-start">
                  <div>
                    <img className="w-full" src="https://assets-prd.ignimgs.com/2021/11/09/eldenring-blogroll-1636494136701.jpg" alt="" />
                  </div>
                  <div className="mt-8">
                    <p className="text-gray-800 dark:text-white lg:text-base text-sm leading-normal">
